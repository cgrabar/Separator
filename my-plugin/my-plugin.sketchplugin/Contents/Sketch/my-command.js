...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var Rectangle = sketch.Rectangle; // var group = new Group({
  //   parent: page,
  ...
  log(myStyle);
  log(rect); //#  for (i = 0; i < rect.style.borders.length; i++) {
  ...
  log(selection.isEmpty);
  rect.selected = true;
  log(selection.isEmpty); // var outputString = sketch.UI.getStringFromUser('Test', 'default')
